...
//                => CheckItemHelper<TItem, TResult>(Execute.Assertion.BecauseOf(because, becauseArgs),
//                    element, typeof(T0));
...
//            TResult CheckItem<TItem>(TItem element)
//                => CheckItemHelper<TItem, TResult>(Execute.Assertion.BecauseOf(because, becauseArgs),
//                    element, typeof(T0), typeof(T1), typeof(T2));
//            var result = Subject.Match(
...
//            TResult CheckItem<TItem>(TItem element)
//                => CheckItemHelper<TItem, TResult>(Execute.Assertion.BecauseOf(because, becauseArgs),
//                    element, typeof(T0), typeof(T1), typeof(T2), typeof(T3));
//            var result = Subject.Match(
...
//            TResult CheckItem<TItem>(TItem element)
//                => CheckItemHelper<TItem, TResult>(Execute.Assertion.BecauseOf(because, becauseArgs),
//                    element, typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4));
//            var result = Subject.Match(
//                CheckItem, CheckItem, CheckItem, CheckItem,
//                CheckItem
//            );
